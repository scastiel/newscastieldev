...
urls:
  - label: Amazon
    url: 'https://amzn.to/3sXdDEf'
  - label: Gumroad
    url: 'https://scastiel.gumroad.com/l/use-hooks'
redirect_from:
  - /books/use-hooks
---
...
This eBook contains the content of my course about React hooks available at [useEffect.dev](https://useeffect.dev?ref=Gumroad).

If you prefer reading lessons in your browser, with interactive examples and exercises, you can purchase access to the course [there](https://useeffect.dev/?ref=Gumroad). The PDF eBook is included in the Premium plan.
