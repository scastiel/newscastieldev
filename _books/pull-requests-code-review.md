...
description: >-
  ...
  comprehensive guide!
urls:
  - label: 'Gumroad (PDF, ePub)'
    url: 'https://scastiel.gumroad.com/l/pull-requests-code-review'
  - label: Amazon (Kindle)
    url: 'https://www.amazon.com/dp/B0CKWSJ4NL'
  - label: GitHub (manuscript)
    url: 'https://github.com/scastiel/book-pr'
redirect_from:
  - /books/pull-requests-code-review
---
...
“It is a joy to read and it is packed with a lot of useful information. I was already following some of the proposed methods and I will definitely integrate others. I already shared this with my mentee and she gained a lot of knowledge.” – [J-M Plourde](https://github.com/giant995)

“Thank you for putting together this book. It was great to find a resource that communicates some of the best practices for PRs that I have picked up along the way, as well as some I had not considered or had not been able to articulate clearly.” – [Kelly Walker](https://github.com/KellyWalker)

“Definitely helping structure how I can share knowledge.” – [Stephane Paul](https://linkedin.com/in/stephanepaul)

“Love the book! Clear, direct, and helpful!” – [John Borsi](https://github.com/jpborsi)
...
I help developers and teams grow by providing [development](https://scs.tl/freelance), [training](https://scs.tl/workshop), and [mentoring](https://scs.tl/mentoring) services. I have authored five [books](https://scs.tl/books) on frontend development, covering topics such as React, Next.js and JavaScript. I also write [blog posts](https://scs.tl/posts) and share my knowledge and insights on various platforms.

In addition to my freelance work, I offer a live [2 to 3-day workshop](https://scs.tl/workshop) to help developers create their first application with React & Next.js, and I serve as a [Front-end Mentor](https://scs.tl/mentoring), helping developers reach their goals in frontend development. I am passionate about learning new technologies and techniques, and I enjoy hiking in the beautiful places that Quebec has to offer.
