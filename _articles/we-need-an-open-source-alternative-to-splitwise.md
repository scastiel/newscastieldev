...
date: '2024-02-04'
excerpt: >-
  After Splitwise began limiting free usage in late 2023, this post argues that a widely used app should be more than just free, and explains why building Spliit as an open source project guarantees users can keep using it freely forever.
lang: en
canonical_url: https://spliit.app/blog/we-need-an-open-source-alternative-to-splitwise/
source_name: Spliit Blog
source_url: https://spliit.app/blog
---

Splitwise was created [in 2012](https://www.crunchbase.com/organization/splitwise) as a free application to split expenses between friends. I used it, you probably used it, everybody did. And it has been working quite well since… well, at least until last fall.
...
![xkcd commic: Univers Price Tiers](/assets/posts/we-need-an-open-source-alternative-to-splitwise/price-tiers.webp)

[_(Source: xkcd: Universe Price Tiers)_](https://xkcd.com/2666/)
...
This is why [Spliit](https://spliit.app) is not only free: it is open source. That means you can take [its source code](https://github.com/spliit-app/spliit), run your own copy, without any kind of approval from me.

That also means that anyone can report an issue, suggest a feature, or even implement it! If you use Spliit, there is a good chance you’ve used a feature developed by one of [Spliit’s amazing contributors](https://github.com/spliit-app/spliit/graphs/contributors)!

![Screenshot of Spliit’s home page, displaying the avatar of its 10 contributors on GitHub.](/assets/posts/we-need-an-open-source-alternative-to-splitwise/contributors.webp)
